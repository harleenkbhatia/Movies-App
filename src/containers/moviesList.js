...
class MoviesList extends React.Component {
    ...
    async componentDidMount() {
        ...
        // await and .then anyone can be used here
    }
            ...
            <div className="main-container">
                ...
                <div className="movie-table-container">
                    <div className="filters">
                        <input value={this.state.search} placeholder="Search for movies here" className="movie-search" type="text" onChange={this.changeSearch} />
